...
use hcf\listener\ClaimListener;
...
class ClaimManager
{
    ...
    public function insideClaim(Position $position): ?Claim
    {
        ...
        if (!empty($claimsInside)) {
            return reset($claimsInside);
        }
        return null;
    }
     ...
     * @param string $world
     */
    public function createClaim(string|int $name, string $type, int $minX, int $maxX, int $minZ, int $maxZ, string $world): void
    {
