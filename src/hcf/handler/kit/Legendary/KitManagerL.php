...
namespace hcf\handler\kit\Legendary;
...
class KitManagerL
{
    ...
    public function __construct(){
        # Register kits
        foreach (HCFLoader::getInstance()->getProvider()->getKitsL() as $name => $data) {
        ...
        HCFLoader::getInstance()->getServer()->getPluginManager()->registerEvents(new KitListenerL(), HCFLoader::getInstance());
    }
    ...
    {
        return HCFLoader::getInstance()->getProvider()->getKitLConfig()->get('organization');
    }
     ...
     * @return Kit|null
     */
    public function getKit(string $kitName): ?KitL
    {
    ...
    {
        $this->kits[$kitName] = new KitL($kitName, $nameFormat, $permission, $itemRepresentative, $items, $armor, $cooldown);
        ...
        if ($new) {
            ...
            HCFLoader::getInstance()->getProvider()->getKitLConfig()->set('organization', $organization);
            HCFLoader::getInstance()->getProvider()->getKitLConfig()->save();
        }
    }
